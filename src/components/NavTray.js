...
function NavTray(props) {
  return(
    <div id="nav-tray" className={`nav ${!props.isTrayOpen ? style.navHide : ''}`}>
      ...
      <div className={`navItems ${style.txt}`}>
        <div className={style.navItem}>
          <a href="#services" onClick={props.toggleTray}>Services</a>
        </div>
        <div class="nav-item">
          <a href="#trainings" onClick={props.toggleTray}>Trainings</a>
        </div>
        <div class="nav-item">
          <a href="#about" onClick={props.toggleTray}>About</a>
        </div>
        <div class="nav-item">
          <a href="./contact.html" onClick={props.toggleTray}>Contact Us</a>
        </div>
      </div>
  </div>
  );
