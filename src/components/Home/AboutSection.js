...
function AboutSection(props) {
  ...
  return (
    <section id="about" className={style.about}>
      ...
      <div className='transitionWrapper bottomWrapper'>
        <svg className={['transition', style.aboutBottomTransition].join(' ')} viewBox="0 0 1440 320"><path fill="#4d724d" fillOpacity="1" d="M0,96L80,101.3C160,107,320,117,480,128C640,139,800,149,960,128C1120,107,1280,53,1360,26.7L1440,0L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
      </div>
    </section>
  );
}
